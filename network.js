  ...
  const I18N = {
    en: {
      ...
      <p><strong>Methodology:</strong> <u>Art historical research</u>: based on systematic analysis of bibliographic and archival sources (correspondence, manuscripts, printed documents, museum catalogues, and exhibition records) from 19th-century France and Spain. Network nodes and edges were constructed through careful cross-referencing of academic publications, institutional databases (museums, cultural institutions, foundations), and verified digital resources.<br>
    ...
    es: {
      ...
      <p><strong>Metodología:</strong> <u>Investigación en Historia del arte</u>: basada en análisis sistemático de fuentes bibliográficas y de archivo (correspondencia, manuscritos, documentos impresos, catálogos de museos y registros de exposiciones) de la Francia y España del siglo XIX. Los nodos y conexiones de la red fueron construidos mediante la cuidadosa comparación cruzada de publicaciones académicas, bases de datos institucionales (museos, instituciones culturales, fundaciones), y recursos digitales verificados.<br>
