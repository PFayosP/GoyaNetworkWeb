  ...
  const I18N = {
    ...
    es: {
      ...
      <p><strong>Metodología:</strong> Investigación en Historia del arte: basada en análisis sistemático de fuentes bibliográficas y de archivo (correspondencia, manuscritos, documentos impresos, catálogos de museos y registros de exposiciones) de la Francia y España del siglo XIX. Los nodos y conexiones de la red fueron construidos mediante la cuidadosa comparación cruzada de publicaciones académicas, bases de datos institucionales (museos, instituciones culturales, fundaciones), y recursos digitales verificados.<br>
      Desarrollo web: realizado con HTML y JavaScript, con datos estructurados en JSON, y control de versiones y despliegue mediante GitHub; desarrollado con el apoyo de ChatGPT (OpenAI), DeepSeek (High-Flyer) y Claude (Anthropic). Configuración inicial del sitio web en colaboración con Anita Verő <a href="https://www.consonant-ai.com" target="_blank">(ConsonantAI)</a>.</p>
