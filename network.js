  ...
  const I18N = {
    en: {
      ...
      <p><strong>Funding:</strong> Work produced with the support of a 2024 Leonardo Grant (<a href="https://www.redleonardo.es/beneficiario/paula-fayos-perez/" target="_blank">Beca Leonardo</a>) for Scientific Research and Cultural Creation, funded by <a href="https://www.fbbva.es/" target="_blank">BBVA Foundation.</a> <a href="https://www.fbbva.es/" target="_blank">BBVA Foundation</a> takes no responsibility for the opinions, statements and contents of this project, which are entirely the responsibility of its authors.</p>

      <p>The project has also secured funding from a research grant by <a href="https://www.gerda-henkel-stiftung.de/" target="_blank">Gerda Henkel Stiftung (Gerda Henkel Foundation).</a></p>
    ...
    es: {
      ...
      <p><strong>Financiación:</strong> Trabajo realizado con el apoyo de una Beca Leonardo 2024 (<a href="https://www.redleonardo.es/beneficiario/paula-fayos-perez/" target="_blank">Beca Leonardo</a>) para Investigación Científica y Creación Cultural, financiada por la <a href="https://www.fbbva.es/" target="_blank">Fundación BBVA.</a> La <a href="https://www.fbbva.es/" target="_blank">Fundación BBVA</a> no asume responsabilidad alguna por las opiniones, afirmaciones y contenidos de este proyecto, que son enteramente responsabilidad de sus autores.</p>

      <p>El proyecto ha contado asimismo con una beca de investigación de la <a href="https://www.gerda-henkel-stiftung.de/" target="_blank">Gerda Henkel Stiftung (Fundación Gerda Henkel).</a></p>
