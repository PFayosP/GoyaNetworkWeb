  ...
  const I18N = {
    en: {
      ...
      Web development: built using HTML and JavaScript, with structured data in JSON, and version control and deployment through GitHub, developed with the assistance of ChatGPT (OpenAI), DeepSeek (High-Flyer), and Claude (Anthropic). Initial website setup in collaboration with Anita Verő.</p>
    ...
    es: {
      ...
      Desarrollo web: realizado con HTML y JavaScript, con datos estructurados en JSON, y control de versiones y despliegue mediante GitHub; desarrollado con el apoyo de ChatGPT (OpenAI), DeepSeek (High-Flyer) y Claude (Anthropic). Configuración inicial del sitio web en colaboración con Anita Verő.</p>
